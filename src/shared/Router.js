  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/:receiverId" element={<MyHome></MyHome>}></Route>
        <Route path="/modal" element={<LoginModal></LoginModal>}></Route>
        <Route
          path="/SignUpModal"
          element={<SignUpModal></SignUpModal>}
        ></Route>
        <Route path="/WriteModal" element={<WriteModal></WriteModal>}></Route>
        <Route path="/ViewModal" element={<ViewModal></ViewModal>}></Route>
      </Routes>
    </BrowserRouter>
  );
};
